...
const symbol1 = 'UNI'
const decimals1 = 18
const address1 = '0xB26B2De65D07eBB5E54C7F6282424D3be670E1f0'
...
export const getPrice = async (inputAmount, slippageAmount, deadline, walletAddress) => {
    ...
    const quoteAmount = route.quote.toFixed(6)
    const ratio = (quoteAmount/inputAmount).toFixed(3)
...
export const runSwap = async (transaction, signer) => {
    const approvalAmount = ethers.utils.parseUnits('10', 18).string()
